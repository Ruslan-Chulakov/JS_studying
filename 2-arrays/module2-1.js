...
// console.log(genres);
// console.log(`first element of array is - ${genres[0]}`);

// const lastElementIndex = genres.length - 1;
// console.log(`last element of array is - ${genres[lastElementIndex]}`);

// // variant 1
// // const deletedFirstElement = genres.shift();
// // variant 2
// const deletedFirstElement = genres.splice(0, 1);
// console.log(`element which was delete is - ${deletedFirstElement}`);

// genres.unshift('Country');
// console.log(genres);

// genres.splice(0, 0, 'Reggae');
// console.log(genres);
...
// variant 1 i think its very bed.....
// let s = 1;

// const arrayFromValues = values.split(' ');
// console.log(arrayFromValues);

// for (let val of arrayFromValues) {
//     s *= val;
//     console.log(val)
// }
// console.log(s);
...
// for (let i = 1; i < stringToArray.length - 1; i += 1) {
...
// const arrayReverseToString = arrayReverse.join('');
// console.log(arrayReverseToString);
