...
// Поэтому можно получить значение свойства legs 
...
// не делает различия между собственными 
// и несобственными свойствами объекта. 
// Эта особенность мешает, так как мы всегда хотим перебрать 
...
// Поэтому при переборе циклом for...in необходимо 
// на каждой итерации добавить проверку на собственное свойство. 
// Даже если сейчас мы уверены в том 
// что у объекта нет несобственных свойств, 
